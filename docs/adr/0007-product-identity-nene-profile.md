# ADR 0007: Product Identity — NeNe Profile
...
| Field | Value |
| --- | --- |
| **Public product name** | **NeNe Profile** |
...
**Name rationale:** "Profile" = a **mapping profile** for a bank format, not user profile.

## Related

- publication-strategy `docs/products/nene-profile.md`
